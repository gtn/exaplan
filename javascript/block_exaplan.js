...
// next month
    ...
    month1El = document.querySelector('#block_exaplan_dashboard_calendar #month1');
    var exaplan_dashboard_calendar_month1 = new TavoCalendar(month1El, month1_options);
    month2El = document.querySelector('#block_exaplan_dashboard_calendar #month2');
...
// month1El.addEventListener('calendar-select', calendarDateSelected);
    month1El.addEventListener('calendar-select', (ev) => {
        return selectedDateSendAjax(ev, exaplan_dashboard_calendar_month1)
    });
    month2El.addEventListener('calendar-select', (ev) => {
        return selectedDateSendAjax(ev, exaplan_dashboard_calendar_month2)
    });
