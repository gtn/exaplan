...
$settings->add(new exaplan_admin_setting_configstandardtext('exaplan/company_name',
    'Firmenname',
    'Bitte einen Firmennamen eingeben',
    "", PARAM_TEXT));

$settings->add(new exaplan_admin_setting_configstandardtext('exaplan/moodle_id', 'Moodle ID',
